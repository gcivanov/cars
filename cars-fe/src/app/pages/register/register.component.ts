...
import { GenderType, RoleType } from 'src/app/services/models/account-event/account';
import { RegistrationRequest } from 'src/app/services/models/account-event/registration-request';
  ...
  ngOnInit() {
    ...
    this.employeeService.getAllPositions().subscribe((positions) => {
      ...
      this.registerForm = this.formBuilder.group({
        ...
        this.registerForm.get('role')?.valueChanges.subscribe((value: RoleType) => this.showCompanyData = value === RoleType.DEALER);
