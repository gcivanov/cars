import { EmployeeService } from '../../../services/service-account/employee.service';
...
import { Account, GenderType, RoleType } from 'src/app/services/models/account-event/account';
import { AccountService } from 'src/app/services/service-account/account.service';
import { PasswordChange } from 'src/app/services/models/account-event/password-change';
import { TranslateService } from '@ngx-translate/core';
import { AccountMyUpdate } from 'src/app/services/models/account-event/account-my-update';
import { formatCustomDate } from 'src/app/theme/utils/app-common';
import { AuthService } from 'src/app/services/auth.service';
import { forkJoin } from "rxjs";
import { Employee, Position } from 'src/app/services/models/account-event/employee';
import { Company } from 'src/app/services/models/account-event/company';
...
export class ProfileComponent implements OnInit {
  ...
  private setupInitForm(info: Account) {
    this.infoForm = this.formBuilder.group({
      ...
      firstName: [info.firstName, {nonNullable: true, validators: [Validators.required, Validators.minLength(2)]}],
      ...
      dateOfBirth: [info.dateOfBirth, {nonNullable: true, validators: [Validators.required, Validators.pattern(/^\d{1,2}\.\d{1,2}\.[1-9]{1}\d{3}$/)]}],
