...
export class EditPropertyComponent implements OnInit {
  ...
  //     this.submitForm.get('basic')?.get('title')?.setValue(this.property.title);
  //     this.submitForm.get('basic')?.get('desc')?.setValue(this.property.desc);
  //     this.submitForm.get('basic')?.get('priceDollar')?.setValue((this.property.priceDollar.sale)?this.property.priceDollar.sale:this.property.priceDollar.rent);
  //     this.submitForm.get('basic')?.get('priceEuro')?.setValue((this.property.priceEuro.sale)?this.property.priceEuro.sale:this.property.priceEuro.rent);
  //     this.submitForm.get('basic')?.get('propertyType')?.setValue( this.propertyTypes.filter(p => p.name == this.property.propertyType)[0]);
  ...
  //       })
  //     })
  //     this.submitForm.get('basic')?.get('propertyStatus')?.setValue(statusList);
  ...
  //       images.push(image);
  //     })
  //     this.submitForm.get('basic')?.get('gallery')?.setValue(images);

  //     this.submitForm.get('address')?.get('location')?.setValue(this.property.formattedAddress);
  //     this.lat = this.property.location.lat;
  //     this.lng = this.property.location.lng;
  //     this.getAddress();

  //     this.submitForm.get('additional')?.get('bedrooms')?.setValue(this.property.bedrooms);
  //     this.submitForm.get('additional')?.get('bathrooms')?.setValue(this.property.bathrooms);
  //     this.submitForm.get('additional')?.get('garages')?.setValue(this.property.garages);
  //     this.submitForm.get('additional')?.get('area')?.setValue(this.property.area.value);
  //     this.submitForm.get('additional')?.get('yearBuilt')?.setValue(this.property.yearBuilt);
  ...
  //         preview: plan.image
  //       }
  //       this.submitForm.get('media')?.get('plans')?['controls'][index].get('image').setValue([image]);
  //     })
  ...
  //     this.submitForm.get('media')?.get('featured')?.setValue(this.property.featured);
  ...
  // // -------------------- Address ---------------------------
  // public onSelectCity(){
  //   this.submitForm.get('address')?.get('neighborhood')?.setValue(null, {emitEvent: false});
  //   this.submitForm.get('address')?.get('street')?.setValue(null, {emitEvent: false});
  // }
